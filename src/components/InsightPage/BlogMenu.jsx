...
const BlogMenu = ({ setMenuSelected, categories, menuSelected }) => {
  return (
    <div className="flex justify-center items-center h-[80px] m-auto w-full px-6 tablet:px-14 laptop:px-[70px] ">
      <div className="w-full max-w-[1440px] flex flex-col-reverse justify-between items-start gap-4 laptop:gap-0 laptop:items-center laptop:flex-row">
