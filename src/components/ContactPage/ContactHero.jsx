...
const ContactHero = () => {
  return (
    <div className="flex justify-center items-center m-auto w-full px-[70px] py-12">
      <div className="w-full max-w-[1440px] flex justify-center items-center gap-[60px]">
        <div className="flex flex-col gap-12 items-start justify-center max-w-[576px] w-full">
