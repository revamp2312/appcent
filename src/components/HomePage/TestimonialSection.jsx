...
const TestimonialSection = () => {
  return (
    <div className="flex justify-center items-center m-auto w-full px-6 tablet:px-14 laptop:px-[70px] py-12  bg-primary-btn-bg">
      <div className="w-full max-w-[1440px] flex flex-col justify-center items-center gap-12">
          <div className="flex flex-col gap-x-2 justify-between items-center laptop:flex-rows" >
