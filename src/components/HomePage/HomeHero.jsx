...
const HomeHero = () => {
  return (
    <div className="flex justify-center items-center m-auto w-full px-6 tablet:px-14 laptop:px-[70px] py-12">
      <div className="w-full max-w-[1440px] flex flex-col justify-start items-center gap-6 laptop:flex-row">
        <div className="flex flex-col gap-12 justify-center items-start max-w-[718px] w-full">
          ...
          <Link href="/demo" className="w-full"><div className="rounded px-6 py-3 bg-primary-btn-bg text-white font-bold w-full text-center">Schedule a Demo</div></Link>
          <Link href="/contact" className="w-full">
          <div className="flex w-full justify-center items-center gap-[10px] rounded px-6 py-3 bg-[var(--primary-color)] border-[1px] border-solid border-[var(--accent-color)] text-[var(--accent-color)] font-bold">
        ...
        <div className="flex justify-center items-center w-full">
            <Image className="w-full" src="/homepage/home-hero.png" alt="Hero Image" width={600} height={576} />
        </div>
      </div>
    </div>
  );
